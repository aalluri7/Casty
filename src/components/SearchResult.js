      ...
      <div style={{display: "flex"}}>
        ...
        <div style={{flex: "1"}}>
           <div style={{position:"relative"}}>
              ...
              <SubscribeBtn data={this.props.data} actions={this.props.actions} subscribehandler={this.props.subscribehandler} data={this.props.data} podcastname={this.props.title}></SubscribeBtn>
