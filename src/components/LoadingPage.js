...
export default class LoadingPage extends Component {
  ...
  stuff() {
    switch (this.props.data.currentView) {
      case "home":
        return <HomePage data={this.props.data} actions={this.props.actions} />;
      case "player":
        return (
          <PodcastViewer data={this.props.data} actions={this.props.actions} />
        );
      case "search":
        return (
          <SearchPage
  ...
  render() {
    ...
    return <div className={"LoadingPage"}>{this.stuff()}</div>;
  }
}
